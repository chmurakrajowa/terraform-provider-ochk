...
// DeleteGfwRuleResponse delete gfw rule response
//
...
// Validate validates this delete gfw rule response
...
// ContextValidate validate this delete gfw rule response based on the context it is used
func (m *DeleteGfwRuleResponse) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *DeleteGfwRuleResponse) contextValidateRequestInstance(ctx context.Context, formats strfmt.Registry) error {
