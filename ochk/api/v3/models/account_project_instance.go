...
// AccountProjectInstance account project instance
//
// swagger:model AccountProjectInstance
...
// Validate validates this account project instance
func (m *AccountProjectInstance) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *AccountProjectInstance) validateAccountID(formats strfmt.Registry) error {
...
func (m *AccountProjectInstance) validateCreationDate(formats strfmt.Registry) error {
...
func (m *AccountProjectInstance) validateID(formats strfmt.Registry) error {
...
func (m *AccountProjectInstance) validateModificationDate(formats strfmt.Registry) error {
...
func (m *AccountProjectInstance) validateProjectID(formats strfmt.Registry) error {
...
func (m *AccountProjectInstance) validateVrfID(formats strfmt.Registry) error {
...
// ContextValidate validates this account project instance based on context it is used
func (m *AccountProjectInstance) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (m *AccountProjectInstance) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *AccountProjectInstance) UnmarshalBinary(b []byte) error {
	var res AccountProjectInstance
