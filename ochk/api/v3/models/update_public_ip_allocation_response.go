...
// UpdatePublicIPAllocationResponse update public Ip allocation response
//
...
// ContextValidate validate this update public Ip allocation response based on the context it is used
func (m *UpdatePublicIPAllocationResponse) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *UpdatePublicIPAllocationResponse) contextValidatePublicIPAllocation(ctx context.Context, formats strfmt.Registry) error {
...
func (m *UpdatePublicIPAllocationResponse) contextValidateRequestInstance(ctx context.Context, formats strfmt.Registry) error {
