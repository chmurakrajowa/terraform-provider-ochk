...
// CreateKmsKeyResponse create kms key response
//
// swagger:model CreateKmsKeyResponse
...
// Validate validates this create kms key response
func (m *CreateKmsKeyResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *CreateKmsKeyResponse) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *CreateKmsKeyResponse) UnmarshalBinary(b []byte) error {
	var res CreateKmsKeyResponse
