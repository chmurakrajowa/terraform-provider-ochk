...
func (m *UpdateTagResponse) validateRequestInstance(formats strfmt.Registry) error {
...
func (m *UpdateTagResponse) validateTag(formats strfmt.Registry) error {
...
func (m *UpdateTagResponse) validateTimestamp(formats strfmt.Registry) error {
...
// ContextValidate validate this update tag response based on the context it is used
...
func (m *UpdateTagResponse) contextValidateRequestInstance(ctx context.Context, formats strfmt.Registry) error {
...
func (m *UpdateTagResponse) contextValidateTag(ctx context.Context, formats strfmt.Registry) error {
