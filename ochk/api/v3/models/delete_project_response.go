...
func (m *DeleteProjectResponse) validateRequestInstance(formats strfmt.Registry) error {
...
func (m *DeleteProjectResponse) validateTimestamp(formats strfmt.Registry) error {
...
// ContextValidate validate this delete project response based on the context it is used
func (m *DeleteProjectResponse) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *DeleteProjectResponse) contextValidateRequestInstance(ctx context.Context, formats strfmt.Registry) error {
