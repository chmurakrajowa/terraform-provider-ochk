...
// UpdateCustomServiceResponse update custom service response
//
// swagger:model UpdateCustomServiceResponse
...
// Validate validates this update custom service response
func (m *UpdateCustomServiceResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *UpdateCustomServiceResponse) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *UpdateCustomServiceResponse) UnmarshalBinary(b []byte) error {
	var res UpdateCustomServiceResponse
