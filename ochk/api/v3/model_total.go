...
// and a boolean to check if the value has been set.
func (o *Total) GetLastIndexOk() (*int64, bool) {
	if o == nil || IsNil(o.LastIndex) {
		return nil, false
	}
...
func (o *Total) HasLastIndex() bool {
	if o != nil && !IsNil(o.LastIndex) {
		return true
	}
...
// SetLastIndex gets a reference to the given int64 and assigns it to the LastIndex field.
func (o *Total) SetLastIndex(v int64) {
	o.LastIndex = &v
}
