...
func (o *DeleteProjectsProjectIDParams) WithProjectID(projectID strfmt.UUID) *DeleteProjectsProjectIDParams {
	o.SetProjectID(projectID)
	return o
}

// SetProjectID adds the projectId to the delete projects project ID params
func (o *DeleteProjectsProjectIDParams) SetProjectID(projectID strfmt.UUID) {
