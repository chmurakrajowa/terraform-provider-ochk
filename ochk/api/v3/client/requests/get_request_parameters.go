...
// WithActive adds the active to the get request params
func (o *GetRequestParams) WithActive(active *bool) *GetRequestParams {
	o.SetActive(active)
	return o
}

// SetActive adds the active to the get request params
func (o *GetRequestParams) SetActive(active *bool) {
	o.Active = active
}
