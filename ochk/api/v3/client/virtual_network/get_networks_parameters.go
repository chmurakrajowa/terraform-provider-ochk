...
// WithDisplayName adds the displayName to the get networks params
func (o *GetNetworksParams) WithDisplayName(displayName *string) *GetNetworksParams {
	o.SetDisplayName(displayName)
	return o
}

// SetDisplayName adds the displayName to the get networks params
func (o *GetNetworksParams) SetDisplayName(displayName *string) {
