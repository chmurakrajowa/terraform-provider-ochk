...
func (o *ApiResponse) GetErrorCode() int32 {
...
func (o *ApiResponse) GetErrorCodeOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ApiResponse) HasErrorCode() bool {
...
func (o *ApiResponse) SetErrorCode(v int32) {
	o.ErrorCode.Set(&v)
}

// SetErrorCodeNil sets the value for ErrorCode to be an explicit nil
func (o *ApiResponse) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}

// UnsetErrorCode ensures that no value is present for ErrorCode, not even an explicit nil
func (o *ApiResponse) UnsetErrorCode() {
	o.ErrorCode.Unset()
}
...
func (o *ApiResponse) SetMessagesNil() {
	o.Messages.Set(nil)
}

// UnsetMessages ensures that no value is present for Messages, not even an explicit nil
func (o *ApiResponse) UnsetMessages() {
	o.Messages.Unset()
}
...
func (o *ApiResponse) GetTimestamp() time.Time {
...
// and a boolean to check if the value has been set.
func (o *ApiResponse) GetTimestampOk() (*time.Time, bool) {
	if o == nil || IsNil(o.Timestamp) {
		return nil, false
	}
...
func (o *ApiResponse) HasTimestamp() bool {
	if o != nil && !IsNil(o.Timestamp) {
		return true
	}
...
func (o *ApiResponse) SetTimestamp(v time.Time) {
	o.Timestamp = &v
}
