...
func (o *NetworkInstance) GetCreationDate() string {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *NetworkInstance) GetCreationDateOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *NetworkInstance) SetCreationDate(v string) {
...
func (o *NetworkInstance) GetModificationDate() string {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *NetworkInstance) GetModificationDateOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *NetworkInstance) SetModificationDate(v string) {
