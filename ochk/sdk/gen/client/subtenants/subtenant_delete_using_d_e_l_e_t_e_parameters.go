...
/* SubtenantDeleteUsingDELETEParams contains all the parameters to send to the API endpoint
   for the subtenant delete using d e l e t e operation.
...
// WithDefaults hydrates default values in the subtenant delete using d e l e t e params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *SubtenantDeleteUsingDELETEParams) WithDefaults() *SubtenantDeleteUsingDELETEParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the subtenant delete using d e l e t e params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *SubtenantDeleteUsingDELETEParams) SetDefaults() {
