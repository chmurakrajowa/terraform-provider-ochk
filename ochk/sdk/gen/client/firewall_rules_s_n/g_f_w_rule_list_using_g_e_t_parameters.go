...
for the g f w rule list using g e t operation typically these are written to a http.Request
*/
...
// WithTimeout adds the timeout to the g f w rule list using g e t params
func (o *GFWRuleListUsingGETParams) WithTimeout(timeout time.Duration) *GFWRuleListUsingGETParams {
	o.SetTimeout(timeout)
	return o
}

// SetTimeout adds the timeout to the g f w rule list using g e t params
func (o *GFWRuleListUsingGETParams) SetTimeout(timeout time.Duration) {
	o.timeout = timeout
}

// WithContext adds the context to the g f w rule list using g e t params
func (o *GFWRuleListUsingGETParams) WithContext(ctx context.Context) *GFWRuleListUsingGETParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the g f w rule list using g e t params
func (o *GFWRuleListUsingGETParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the g f w rule list using g e t params
func (o *GFWRuleListUsingGETParams) WithHTTPClient(client *http.Client) *GFWRuleListUsingGETParams {
	o.SetHTTPClient(client)
	return o
}

// SetHTTPClient adds the HTTPClient to the g f w rule list using g e t params
...
// SetGatewayPolicyID adds the gatewayPolicyId to the g f w rule list using g e t params
func (o *GFWRuleListUsingGETParams) SetGatewayPolicyID(gatewayPolicyID string) {
