...
for the g f w rule create using p u t operation typically these are written to a http.Request
*/
...
// WithTimeout adds the timeout to the g f w rule create using p u t params
func (o *GFWRuleCreateUsingPUTParams) WithTimeout(timeout time.Duration) *GFWRuleCreateUsingPUTParams {
	o.SetTimeout(timeout)
	return o
}

// SetTimeout adds the timeout to the g f w rule create using p u t params
func (o *GFWRuleCreateUsingPUTParams) SetTimeout(timeout time.Duration) {
	o.timeout = timeout
}

// WithContext adds the context to the g f w rule create using p u t params
func (o *GFWRuleCreateUsingPUTParams) WithContext(ctx context.Context) *GFWRuleCreateUsingPUTParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the g f w rule create using p u t params
func (o *GFWRuleCreateUsingPUTParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the g f w rule create using p u t params
func (o *GFWRuleCreateUsingPUTParams) WithHTTPClient(client *http.Client) *GFWRuleCreateUsingPUTParams {
	o.SetHTTPClient(client)
	return o
}

// SetHTTPClient adds the HTTPClient to the g f w rule create using p u t params
func (o *GFWRuleCreateUsingPUTParams) SetHTTPClient(client *http.Client) {
	o.HTTPClient = client
}

// WithGatewayPolicyID adds the gatewayPolicyID to the g f w rule create using p u t params
...
// SetGatewayPolicyID adds the gatewayPolicyId to the g f w rule create using p u t params
func (o *GFWRuleCreateUsingPUTParams) SetGatewayPolicyID(gatewayPolicyID string) {
	o.GatewayPolicyID = gatewayPolicyID
}

// WithGfwRule adds the gfwRule to the g f w rule create using p u t params
func (o *GFWRuleCreateUsingPUTParams) WithGfwRule(gfwRule *models.GFWRule) *GFWRuleCreateUsingPUTParams {
	o.SetGfwRule(gfwRule)
	return o
}

// SetGfwRule adds the gfwRule to the g f w rule create using p u t params
