...
// New creates a new request controller API client.
func New(transport runtime.ClientTransport, formats strfmt.Registry) ClientService {
	return &Client{transport: transport, formats: formats}
}

/*
Client for request controller API
*/
type Client struct {
...
/*
  RequestGetUsingGET requests get
*/
func (a *Client) RequestGetUsingGET(params *RequestGetUsingGETParams) (*RequestGetUsingGETOK, error) {
	...
	success, ok := result.(*RequestGetUsingGETOK)
	if ok {
		return success, nil
	}
...
/*
  RequestListUsingGET requests list
*/
func (a *Client) RequestListUsingGET(params *RequestListUsingGETParams) (*RequestListUsingGETOK, error) {
	...
	success, ok := result.(*RequestListUsingGETOK)
	if ok {
		return success, nil
	}
	// unexpected success response
