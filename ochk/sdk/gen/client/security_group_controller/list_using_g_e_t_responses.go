...
func (o *ListUsingGETOK) Error() string {
	return fmt.Sprintf("[GET /nsx/sg/][%d] listUsingGETOK  %+v", 200, o.Payload)
}

func (o *ListUsingGETOK) GetPayload() *models.SecurityGroupListResponse {
	return o.Payload
}
...
func (o *ListUsingGETUnauthorized) Error() string {
	return fmt.Sprintf("[GET /nsx/sg/][%d] listUsingGETUnauthorized ", 401)
}
...
func (o *ListUsingGETForbidden) Error() string {
	return fmt.Sprintf("[GET /nsx/sg/][%d] listUsingGETForbidden ", 403)
}
...
func (o *ListUsingGETNotFound) Error() string {
	return fmt.Sprintf("[GET /nsx/sg/][%d] listUsingGETNotFound ", 404)
}
