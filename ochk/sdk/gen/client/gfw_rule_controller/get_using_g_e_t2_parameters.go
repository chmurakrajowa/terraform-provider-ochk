...
// WithRuleID adds the ruleID to the get using g e t 2 params
func (o *GetUsingGET2Params) WithRuleID(ruleID string) *GetUsingGET2Params {
	o.SetRuleID(ruleID)
	return o
}

// SetRuleID adds the ruleId to the get using g e t 2 params
func (o *GetUsingGET2Params) SetRuleID(ruleID string) {
	o.RuleID = ruleID
}

// WithGatewayPolicyID adds the gatewayPolicyID to the get using g e t 2 params
func (o *GetUsingGET2Params) WithGatewayPolicyID(gatewayPolicyID string) *GetUsingGET2Params {
	o.SetGatewayPolicyID(gatewayPolicyID)
	return o
}

// SetGatewayPolicyID adds the gatewayPolicyId to the get using g e t 2 params
func (o *GetUsingGET2Params) SetGatewayPolicyID(gatewayPolicyID string) {
