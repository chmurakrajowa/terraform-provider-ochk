...
// UpdateGroupInstanceResponse UpdateGroupInstanceResponse
//
// swagger:model UpdateGroupInstanceResponse
type UpdateGroupInstanceResponse struct {
...
// Validate validates this update group instance response
func (m *UpdateGroupInstanceResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *UpdateGroupInstanceResponse) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *UpdateGroupInstanceResponse) UnmarshalBinary(b []byte) error {
	var res UpdateGroupInstanceResponse
