...
type RequestInstance struct {
	...
	// request type
	// Enum: [FIREWALL_DFW_RULE_CREATE FIREWALL_DFW_RULE_DELETE FIREWALL_DFW_RULE_UPDATE FIREWALL_GFW_RULE_CREATE FIREWALL_GFW_RULE_DELETE FIREWALL_GFW_RULE_UPDATE ROUTER_CREATE ROUTER_DELETE ROUTER_UPDATE SECURITY_GROUP_CREATE SECURITY_GROUP_DELETE SECURITY_GROUP_UPDATE]
...
func init() {
	var res []string
	if err := json.Unmarshal([]byte(`["FIREWALL_DFW_RULE_CREATE","FIREWALL_DFW_RULE_DELETE","FIREWALL_DFW_RULE_UPDATE","FIREWALL_GFW_RULE_CREATE","FIREWALL_GFW_RULE_DELETE","FIREWALL_GFW_RULE_UPDATE","ROUTER_CREATE","ROUTER_DELETE","ROUTER_UPDATE","SECURITY_GROUP_CREATE","SECURITY_GROUP_DELETE","SECURITY_GROUP_UPDATE"]`), &res); err != nil {
		panic(err)
	}
	for _, v := range res {
