...
//
// swagger:model ProjectCreateResponse
...
// Validate validates this project create response
func (m *ProjectCreateResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ProjectCreateResponse) validateProjectInstance(formats strfmt.Registry) error {
...
func (m *ProjectCreateResponse) validateRequestInstance(formats strfmt.Registry) error {
...
func (m *ProjectCreateResponse) validateTimestamp(formats strfmt.Registry) error {
...
// ContextValidate validate this project create response based on the context it is used
func (m *ProjectCreateResponse) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *ProjectCreateResponse) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *ProjectCreateResponse) UnmarshalBinary(b []byte) error {
	var res ProjectCreateResponse
