...
// ContextValidate validate this sub attribute instance based on the context it is used
func (m *SubAttributeInstance) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error

	if err := m.contextValidateSubAttributeValueList(ctx, formats); err != nil {
		res = append(res, err)
	}
...
func (m *SubAttributeInstance) contextValidateSubAttributeValueList(ctx context.Context, formats strfmt.Registry) error {
