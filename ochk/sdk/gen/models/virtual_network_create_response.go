...
// VirtualNetworkCreateResponse VirtualNetworkCreateResponse
//
// swagger:model VirtualNetworkCreateResponse
...
// Validate validates this virtual network create response
func (m *VirtualNetworkCreateResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *VirtualNetworkCreateResponse) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *VirtualNetworkCreateResponse) UnmarshalBinary(b []byte) error {
	var res VirtualNetworkCreateResponse
