...
// ContextValidate validate this router list response based on the context it is used
func (m *RouterListResponse) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *RouterListResponse) contextValidateRouterCollection(ctx context.Context, formats strfmt.Registry) error {
