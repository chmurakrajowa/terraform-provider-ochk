...
func (m *TagGetResponse) validateTag(formats strfmt.Registry) error {
...
func (m *TagGetResponse) validateTimestamp(formats strfmt.Registry) error {
...
// ContextValidate validate this tag get response based on the context it is used
