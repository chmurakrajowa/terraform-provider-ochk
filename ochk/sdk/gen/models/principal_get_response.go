...
// ContextValidate validate this principal get response based on the context it is used
func (m *PrincipalGetResponse) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *PrincipalGetResponse) contextValidatePrincipalID(ctx context.Context, formats strfmt.Registry) error {
