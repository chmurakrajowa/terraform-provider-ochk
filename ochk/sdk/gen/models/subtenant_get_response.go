...
// ContextValidate validate this subtenant get response based on the context it is used
func (m *SubtenantGetResponse) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *SubtenantGetResponse) contextValidateSubtenantInstance(ctx context.Context, formats strfmt.Registry) error {
