...
// ContextValidate validates this gateway policy based on context it is used
func (m *GatewayPolicy) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
