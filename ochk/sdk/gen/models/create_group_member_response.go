...
//
// swagger:model CreateGroupMemberResponse
...
// Validate validates this create group member response
func (m *CreateGroupMemberResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *CreateGroupMemberResponse) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *CreateGroupMemberResponse) UnmarshalBinary(b []byte) error {
	var res CreateGroupMemberResponse
