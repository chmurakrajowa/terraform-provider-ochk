...
// ContextValidate validate this gateway policy get response based on the context it is used
func (m *GatewayPolicyGetResponse) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error

	if err := m.contextValidateGatewayPolicy(ctx, formats); err != nil {
		res = append(res, err)
	}
...
func (m *GatewayPolicyGetResponse) contextValidateGatewayPolicy(ctx context.Context, formats strfmt.Registry) error {
