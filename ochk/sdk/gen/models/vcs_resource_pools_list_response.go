		...
		if m.VcsResourcePoolInstanceCollection[i] != nil {
			if err := m.VcsResourcePoolInstanceCollection[i].Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					...
					return ce.ValidateName("vcsResourcePoolInstanceCollection" + "." + strconv.Itoa(i))
				}
				return err
			}
		}
...
// ContextValidate validate this vcs resource pools list response based on the context it is used
func (m *VcsResourcePoolsListResponse) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error

	if err := m.contextValidateVcsResourcePoolInstanceCollection(ctx, formats); err != nil {
		res = append(res, err)
	}
...
func (m *VcsResourcePoolsListResponse) contextValidateVcsResourcePoolInstanceCollection(ctx context.Context, formats strfmt.Registry) error {

	for i := 0; i < len(m.VcsResourcePoolInstanceCollection); i++ {

		if m.VcsResourcePoolInstanceCollection[i] != nil {
			if err := m.VcsResourcePoolInstanceCollection[i].ContextValidate(ctx, formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					return ve.ValidateName("vcsResourcePoolInstanceCollection" + "." + strconv.Itoa(i))
				} else if ce, ok := err.(*errors.CompositeError); ok {
					return ce.ValidateName("vcsResourcePoolInstanceCollection" + "." + strconv.Itoa(i))
